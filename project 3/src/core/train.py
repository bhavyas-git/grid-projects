...
def train_model(model,
    ...
    log_path = log_dir / f"{strategy}_{timestamp}.log"
    best_md_path = summary_dir / f"{strategy}_best.md"
    best_ckpt_path = ckpt_dir / f"{strategy}_best.pth"
    ...
    for epoch in range(epochs):
        ...
        if val_acc > best_val:
            ...
            best_summary = [
                f"# Training Summary ({strategy.upper()})\n",
                f"**Model:** {model_name}",
                f"**Device:** {device}",
