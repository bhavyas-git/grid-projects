...
I acquired my dataset from this [website](https://bechdeltest.com/) (click [here](https://github.com/bhavyas-git/grid-projects/blob/main/scrape_result.csv) to view it) using this [API documentation](https://bechdeltest.com/api/v1/doc)
This dataset came with imdb ids, movie titles, Beckdel ratings and year of release. For more features to use in analysis I have scraped the official imdb website using the imdb ids to get genres, imdb ratings and descriptions of each movie. scraped dataset is already provided for ease of execution but can be reproduced using this [scrape_bechdel.ipynb](https://github.com/bhavyas-git/grid-projects/blob/main/scrape_bechdel.ipynb) file. 
