...
The `focal` strategy provides the best overall balance across classes, while `focal` is more effective for handling minority classes. This demonstrates the trade-off between overall accuracy and minority class sensitivity.
